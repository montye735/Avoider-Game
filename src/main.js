...
function startGame() {
    reset();
    loop();
    alert("Rules of the game " + "(1: You can only move left and right on bottom row.)" +  "(2: You have to avoid the red enemies coming down.)")
    alert("Starting New Game! Good Luck!")
}
